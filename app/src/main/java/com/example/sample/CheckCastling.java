...
public class CheckCastling {
    ...
    public static void CheckWhiteCastling(){
        ...
        if(CanWhiteKingEverCastle == true)
        {
            if(CanWhiteKingEverLongCastle == true)
            {
                ...
                {
                    if(i == 51 || i == 41 || i == 31 || !img[3][0].getTag().toString().equals("0") || !img[2][0].getTag().toString().equals("0") || !img[1][0].getTag().toString().equals("0"))
                    {
            ...
            if(CanWhiteKingEverShortCastle)
            {
                ...
                for(int i:squaresControlledByBlack)
                {
                    if(i == 51 || i == 61 || i == 71 || !img[5][0].getTag().toString().equals("0") || !img[6][0].getTag().toString().equals("0"))
                    {
    ...
    public static void CheckBlackCastling(){
            ...
            if(CanBlackKingEverCastle == true)
            {
                if(CanBlackKingEverLongCastle == true)
                {
                    updateSquaresControlledByWhite();
                    boolean isLongCastlingPossible = true;
                    for(int i:squaresControlledByWhite)
                    {
                        if(i == 58 || i == 48 || i == 38 || !img[3][7].getTag().toString().equals("0") || !img[2][7].getTag().toString().equals("0") || !img[1][7].getTag().toString().equals("0"))
                        {
                            isLongCastlingPossible = false;
                            break;
                        }
                ...
                if(CanBlackKingEverShortCastle)
                {
                    ...
                    for(int i:squaresControlledByWhite)
                    {
                        if(i == 58 || i == 68 || i == 78 || !img[5][7].getTag().toString().equals("0") || !img[6][7].getTag().toString().equals("0"))
                        {
                            isShortCastlingPossible = false;
                            break;
                        }
